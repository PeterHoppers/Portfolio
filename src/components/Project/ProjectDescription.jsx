            ...
            {projectName === "VR Cornhole Training" &&
                <>
                    <div className='project-description__short-summary'>
                        ...
                        <p><b>Team Size:</b> 1</p>
                        <p><b>Duration:</b> November 2023 - Feburary 2024</p>
                    </div>                    
                    <h3>Roles and Responsiblities:</h3>
            ...
            {projectName === "Endless Scramble" &&
                <>
                    ...
                    <ul>
                        ...
                        <li>Added medals to the game after it was discovered that time restriants increased the overall fun of the game</li>
            ...
            {projectName === "CHARGED" &&
                <>
                    <div className='project-description__short-summary'>
                        ...
                        <p><b>Duration:</b> November 2016 - Decemeber 2016</p>
                    </div>                    
                    <h3>Roles and Responsiblities:</h3>
                    <h4>Product Owner</h4>
                    <ul>
                    ...
                    <h4>Lead Designer</h4>
                    <ul>
                        <li>Pitched the game concept of pushing and pulling a particle from one end to another through points you placed with a slide presentation</li>
                        <li>Communicated design vision through multiple mediums to help resolve miscommunication issues that initally occurred during developement</li>
            ...
            {projectName === "Creator Colosseum" &&
                <>
                    ...
                    <ul>
                        ...
                        <li>Collobrated with other programmers to help intigrate health and stamina into the movement and combat systems</li>
                    </ul>
                    <h4>Scrum Master</h4>
                    <ul>
            ...
            {projectName === "Inclusion" &&
                <>
                    <div className='project-description__short-summary'>
                        ...
                        <p><b>Team Size:</b> 1</p>
                        <p><b>Duration:</b> November 2018 - Decemeber 2018</p>
                    </div>                    
                    <h3>Roles and Responsiblities:</h3>
                    <h4>Game Writer</h4>
                    <ul>                        
